<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="index.html">
                <img src="../assets/layouts/layout/img/logo.png"
                    alt="logo"
                            ...
                            <ul class="dropdown-menu-list scroller"
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="message"> Vivamus sed auctor nibh congue nibh. auctor nibh auctor
                                            nibh... </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="message"> Vivamus sed congue nibh auctor nibh congue nibh. auctor
